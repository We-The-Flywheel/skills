...
**Background:** This skill adapts the RED-GREEN-REFACTOR cycle from Test-Driven Development to documentation (see the TDD Mapping table below for the full mapping) — no separate TDD skill needs to be read first.
...
**Background:** Standard Test-Driven Development explains why this matters; the same principles apply to documentation.
