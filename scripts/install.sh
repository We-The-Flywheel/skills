...
SKILLS=(humanizer multi-llm-deliberation visual-qa premortem end idiocy-check release-gate content-gate moodboard website-build longterm pangram ultrahumanizer)
